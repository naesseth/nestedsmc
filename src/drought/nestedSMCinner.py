...
class inner:
    ...
    for nested SMC procedure on the row space.
    ...
    y : 1-D array_like
        Measurements.
    N : int
        Number of particles in row filter.
    xTimeCond : 1-D array_like
        Conditional trajectory from previous time step.
    xTimeCond : 1-D array_like
        Conditional trajectory from previous column.
